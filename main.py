...
if select == "House Price Prediction":
    ...
    house = pd.read_csv(r"C:\Users\karth\Downloads\House Price India.csv")
...
if select == "Salary Prediction":
    ...
    salary = pd.read_csv(r"C:\Users\karth\Downloads\Salary Data.csv")
...
if select == "Loan Prediction":
    ...
    """
    st.markdown(title_html, unsafe_allow_html=True)
    loan = pd.read_csv(r"C:\Users\karth\Downloads\train_u6lujuX_CVtuZ9i (1).csv")
...
if select == "Car Price Prediction":
    ...
    """
    st.markdown(title_html, unsafe_allow_html=True)
    car = pd.read_csv(r"C:\Users\karth\Downloads\car data.csv")
    le = LabelEncoder()
